...
Auto-updated tracking of AMD GPU ecosystem projects. Last updated: **2026-03-10 08:30 UTC**

## Overview

| Project | Role | Latest Release | Open PRs | Open Issues | Links |
|---------|------|----------------|----------|-------------|-------|
| **pytorch** | watch | v2.10.0 | 56 | 59 | [repo](https://github.com/pytorch/pytorch) |
| **jax** | watch | jax-v0.9.1 | 16 | 33 | [repo](https://github.com/jax-ml/jax) |
| **vllm** | watch | v0.17.0 | 74 | 58 | [repo](https://github.com/vllm-project/vllm) / [fork](https://github.com/sunway513/vllm) |
| **sglang** | watch | v0.5.9 | 61 | 43 | [repo](https://github.com/sgl-project/sglang) |
...
| **aiter** | dev | v0.1.9 | 171 | 108 | [repo](https://github.com/ROCm/aiter) / [fork](https://github.com/sunway513/aiter) |
| **atom** | dev | - | 45 | 14 | [repo](https://github.com/ROCm/ATOM) / [fork](https://github.com/sunway513/ATOM) |
| **mori** | dev | - | 10 | 10 | [repo](https://github.com/ROCm/mori) / [fork](https://github.com/sunway513/mori) |
| **flydsl** | dev | exp_i8smooth_v0.1 | 4 | 8 | [repo](https://github.com/ROCm/FlyDSL) / [fork](https://github.com/sunway513/FlyDSL) |
