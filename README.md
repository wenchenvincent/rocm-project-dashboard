...
Auto-updated tracking of AMD GPU ecosystem projects. Last updated: **2026-09-07 13:48 UTC**

## Overview

| Project | Role | Latest Release | Open PRs | Open Issues | Links |
|---------|------|----------------|----------|-------------|-------|
| **pytorch** | watch | v2.14.0 | 56 | 55 | [repo](https://github.com/pytorch/pytorch) |
| **jax** | watch | jax-v0.11.1 | 15 | 26 | [repo](https://github.com/jax-ml/jax) |
| **vllm** | watch | v0.28.0 | 70 | 57 | [repo](https://github.com/vllm-project/vllm) / [fork](https://github.com/sunway513/vllm) |
| **sglang** | watch | v0.5.19 | 59 | 55 | [repo](https://github.com/sgl-project/sglang) |
...
| **aiter** | dev | v0.1.21.post1 | 620 | 303 | [repo](https://github.com/ROCm/aiter) / [fork](https://github.com/sunway513/aiter) |
| **atom** | dev | v0.1.6-rc0 | 242 | 91 | [repo](https://github.com/ROCm/ATOM) / [fork](https://github.com/sunway513/ATOM) |
| **mori** | dev | v1.2.2 | 38 | 22 | [repo](https://github.com/ROCm/mori) / [fork](https://github.com/sunway513/mori) |
| **flydsl** | dev | v0.3.2 | 77 | 52 | [repo](https://github.com/ROCm/FlyDSL) / [fork](https://github.com/sunway513/FlyDSL) |
