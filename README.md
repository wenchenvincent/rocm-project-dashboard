...
Auto-updated tracking of AMD GPU ecosystem projects. Last updated: **2026-03-26 08:43 UTC**

## Overview

| Project | Role | Latest Release | Open PRs | Open Issues | Links |
|---------|------|----------------|----------|-------------|-------|
| **pytorch** | watch | v2.11.0 | 46 | 51 | [repo](https://github.com/pytorch/pytorch) |
| **jax** | watch | jax-v0.9.2 | 8 | 33 | [repo](https://github.com/jax-ml/jax) |
| **vllm** | watch | v0.18.0 | 68 | 49 | [repo](https://github.com/vllm-project/vllm) / [fork](https://github.com/sunway513/vllm) |
| **sglang** | watch | v0.5.9 | 63 | 41 | [repo](https://github.com/sgl-project/sglang) |
| **triton** | watch | v3.6.0 | 29 | 13 | [repo](https://github.com/triton-lang/triton) |
...
| **transformer_engine** | dev | v2.6_rocm | 26 | 7 | [repo](https://github.com/ROCm/TransformerEngine) |
