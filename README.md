...
Auto-updated tracking of AMD GPU ecosystem projects. Last updated: **2026-04-04 08:30 UTC**

## Overview

| Project | Role | Latest Release | Open PRs | Open Issues | Links |
|---------|------|----------------|----------|-------------|-------|
| **pytorch** | watch | v2.11.0 | 43 | 48 | [repo](https://github.com/pytorch/pytorch) |
| **jax** | watch | jax-v0.9.2 | 6 | 32 | [repo](https://github.com/jax-ml/jax) |
| **vllm** | watch | v0.19.0 | 67 | 46 | [repo](https://github.com/vllm-project/vllm) / [fork](https://github.com/sunway513/vllm) |
| **sglang** | watch | v0.5.10rc0 | 63 | 44 | [repo](https://github.com/sgl-project/sglang) |
...
| **transformer_engine** | dev | v2.8_rocm | 29 | 7 | [repo](https://github.com/ROCm/TransformerEngine) |
