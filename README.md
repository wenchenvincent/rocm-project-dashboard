...
Auto-updated tracking of AMD GPU ecosystem projects. Last updated: **2026-07-18 09:16 UTC**

## Overview

| Project | Role | Latest Release | Open PRs | Open Issues | Links |
|---------|------|----------------|----------|-------------|-------|
| **pytorch** | watch | v2.13.0 | 50 | 41 | [repo](https://github.com/pytorch/pytorch) |
| **jax** | watch | jax-v0.11.0 | 17 | 26 | [repo](https://github.com/jax-ml/jax) |
| **vllm** | watch | v0.25.1 | 65 | 41 | [repo](https://github.com/vllm-project/vllm) / [fork](https://github.com/sunway513/vllm) |
| **sglang** | watch | v0.5.15.post1 | 61 | 51 | [repo](https://github.com/sgl-project/sglang) |
...
| **aiter** | dev | v0.1.17 | 397 | 220 | [repo](https://github.com/ROCm/aiter) / [fork](https://github.com/sunway513/aiter) |
