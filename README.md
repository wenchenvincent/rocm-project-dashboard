...
Auto-updated tracking of AMD GPU ecosystem projects. Last updated: **2026-09-21 14:41 UTC**

## Overview

| Project | Role | Latest Release | Open PRs | Open Issues | Links |
|---------|------|----------------|----------|-------------|-------|
| **pytorch** | watch | v2.14.0 | 50 | 53 | [repo](https://github.com/pytorch/pytorch) |
| **jax** | watch | jax-v0.11.2 | 15 | 25 | [repo](https://github.com/jax-ml/jax) |
| **vllm** | watch | v0.29.0 | 70 | 53 | [repo](https://github.com/vllm-project/vllm) / [fork](https://github.com/sunway513/vllm) |
| **sglang** | watch | v0.5.20 | 57 | 55 | [repo](https://github.com/sgl-project/sglang) |
...
| **aiter** | dev | v0.1.22.post1 | 669 | 331 | [repo](https://github.com/ROCm/aiter) / [fork](https://github.com/sunway513/aiter) |
| **atom** | dev | v0.1.6-rc0 | 259 | 89 | [repo](https://github.com/ROCm/ATOM) / [fork](https://github.com/sunway513/ATOM) |
| **mori** | dev | v1.2.3.post1 | 44 | 22 | [repo](https://github.com/ROCm/mori) / [fork](https://github.com/sunway513/mori) |
