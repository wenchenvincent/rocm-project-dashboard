...
Auto-updated tracking of AMD GPU ecosystem projects. Last updated: **2026-04-08 08:52 UTC**

## Overview

| Project | Role | Latest Release | Open PRs | Open Issues | Links |
|---------|------|----------------|----------|-------------|-------|
| **pytorch** | watch | v2.11.0 | 41 | 54 | [repo](https://github.com/pytorch/pytorch) |
| **jax** | watch | jax-v0.9.2 | 8 | 28 | [repo](https://github.com/jax-ml/jax) |
| **vllm** | watch | v0.19.0 | 70 | 52 | [repo](https://github.com/vllm-project/vllm) / [fork](https://github.com/sunway513/vllm) |
| **sglang** | watch | v0.5.10 | 60 | 43 | [repo](https://github.com/sgl-project/sglang) |
...
| **aiter** | dev | v0.1.9 | 215 | 143 | [repo](https://github.com/ROCm/aiter) / [fork](https://github.com/sunway513/aiter) |
| **atom** | dev | v0.1.2 | 59 | 21 | [repo](https://github.com/ROCm/ATOM) / [fork](https://github.com/sunway513/ATOM) |
| **mori** | dev | v0.1.0 | 11 | 12 | [repo](https://github.com/ROCm/mori) / [fork](https://github.com/sunway513/mori) |
| **flydsl** | dev | v0.1.2 | 18 | 20 | [repo](https://github.com/ROCm/FlyDSL) / [fork](https://github.com/sunway513/FlyDSL) |
