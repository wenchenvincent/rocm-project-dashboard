...
- Opened: [#179444](https://github.com/pytorch/pytorch/pull/179444) Fix #157256: Bypass arena memory limit computation for custo (@luaartist)
...
- Opened: [#39033](https://github.com/vllm-project/vllm/pull/39033) [Bugfix][MoE] Fix hardcoded SharedExperts output buffer size (@Gregory-Pereira)
