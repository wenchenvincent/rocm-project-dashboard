...
### sglang
- Opened: [#18978](https://github.com/sgl-project/sglang/pull/18978) [AMD] [DO NOT MERGE] Fix mi35x dsv32 mtp nightly (@bingxche)
...
- Merged: [#9362](https://github.com/triton-lang/triton/pull/9362) [AMD][Backend] Add LLVM lowering support for PartitionedShar (@plognjen)
- Merged: [#9421](https://github.com/triton-lang/triton/pull/9421) [AMD][gfx1250] Adjust (BLOCK) M/N in f16 gemm examples (@antiagainst)

### migraphx
- Opened: [#4619](https://github.com/ROCm/AMDMIGraphX/pull/4619) [CI Test] Reintroduce blaze for better ref gemm performance (@kahmed10)
...
- Opened: [#4602](https://github.com/ROCm/AMDMIGraphX/pull/4602) Bump cryptography from 44.0.1 to 46.0.5 in /docs/sphinx (@dependabot[bot])
...
- Opened: [#4603](https://github.com/ROCm/AMDMIGraphX/pull/4603) Prevent propagate precision across precision boundaries for  (@kahmed10)
- Opened: [#4604](https://github.com/ROCm/AMDMIGraphX/pull/4604) [AIMIGRAPHX-563] Fix compilation issue on RHEL systems (@eddieliao)
...
- Merged: [#4341](https://github.com/ROCm/AMDMIGraphX/pull/4341) Breakout get onnx op list in MIGraphX Cpp API (@TedThemistokleous)

### aiter
- Opened: [#2060](https://github.com/ROCm/aiter/pull/2060) GFX1250 Kernels - GEMMa8w8 blockscale (@amirumoAMD)
- Opened: [#2034](https://github.com/ROCm/aiter/pull/2034) Top-K Top-P Sampling Kernel Optimization (@aryaman-gupta)
...
- [#4605](https://github.com/ROCm/AMDMIGraphX/issues/4605) #4550 introduces doubling bug to DNT model (@CharlieL7)
